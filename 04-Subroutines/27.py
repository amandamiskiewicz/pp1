'''27.The credit card number consists of 16 digits. In a separate module, 
...
Then, create a program that masks some credit card digits. 
Import the module with the created function. Finally, display the credit card number. Sample result:
f("5290312400019022") returns "52**********9022"
'''

import maskcardnumber

print(maskcardnumber.f("5290312400019022"))